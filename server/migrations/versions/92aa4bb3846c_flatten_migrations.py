...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("starttls", sa.Boolean(), server_default=sa.text("0"), nullable=True),
        sa.Column("ssl_tls", sa.Boolean(), server_default=sa.text("0"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("first_login", sa.Boolean(), server_default=sa.text("1"), nullable=False),
