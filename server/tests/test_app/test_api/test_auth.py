...
class TestLogin:
    def test__given_credentials__when_already_authenticated__then_400_returned(self, client_tester: FlaskClient):
    ...
    def test__given_credentials__when_password_is_wrong__then_403_returned(self, client_tester: FlaskClient):
    ...
    def test__given_credentials__when_credentials_are_valid__then_200_returned(self, client_tester: FlaskClient):
    ...
    def test__given_credentials__when_mfa_configured__then_200_returned(self, client_tester: FlaskClient):
    ...
    def test__given_credentials__when_invalid_mfa__then_400_returned(self, pyotp_mocker: mock.MagicMock, client_tester: FlaskClient):
    ...
    @mock.patch("app.api.auth.pyotp")
    def test__given_credentials__when_mfa_configured_and_valid__then_200_returned(self, pyotp_mocker: mock.MagicMock, client_tester: FlaskClient):
...
class TestLogout:
    def test__given_jti__then_added_to_blocklist(self, client_tester: FlaskClient):
        access_token, refresh_token = Helpers.login(client_tester, "admin", "xss")
