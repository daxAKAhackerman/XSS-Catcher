...
def test_change_password(client):
    ...
    rv = change_password(client, old_password="xss", password1="a", password2="a")
    ...
    rv = change_password(client, old_password="xss", password1="Password123!", password2="Password122!")
    assert b"Passwords don't match" in rv.data
    rv = change_password(client, old_password="xss2", password1="Password123!", password2="Password123!")
    assert b"Old password is incorrect" in rv.data
    change_password(client, old_password="xss", password1="Password123!", password2="Password123!")
    logout(client)
